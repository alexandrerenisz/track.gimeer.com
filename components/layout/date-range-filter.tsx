...
export function DateRangeFilter() {
  ...
  return (
    <div className="relative flex min-w-0 items-center gap-2">
      {/* overflow-x-auto + min-w-0: no mobile essa linha não cabe inteira —
          em vez de forçar o Topbar (e a página inteira) mais largo que a
          tela, ela rola horizontalmente dentro de si mesma. */}
      <div className="flex min-w-0 items-center gap-1 overflow-x-auto rounded-md border border-border bg-background p-1 text-xs">
