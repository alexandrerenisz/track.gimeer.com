...
// "lead" tirado do funil por enquanto (decisão do usuário) — a RPC ainda pode
// devolver esse stage, o componente só ignora o que não está em STAGE_ORDER.
const STAGE_ORDER = ["visited", "checkout", "purchase", "schedule"];
